...
> 상태: In Progress — Career Hub, G1, 기업 MVP P3~P6 및 P7-01 완료, P7-02 진행 대기
> 기준일: 2026-08-19
> 구현 시작 예정: 2026-08-20
...
- [x] P3-03 CompanySignupFacade와 기업 가입 API 구현 (완료: 2026-09-07, P3-03 단위·웹 10/10·MySQL 가입 3/3·전체 MySQL 64/64)
- [x] P4-01 V6 verification DDL·도메인·관리자 승인/반려 구현 (완료: 2026-09-08, 단위·웹 18/18·MySQL V6/트랜잭션 6/6·전체 MySQL 70/70)
