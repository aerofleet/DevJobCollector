...
> 상태: In Progress — P0-01 운영 감사 실행 중  
> 기준일: 2026-08-19  
> 구현 시작 예정: 2026-08-20  
...
- [ ] P0-01 운영 DB/Flyway V2 감사 및 익명화 스냅샷 준비 (1일, P0)
- [ ] P0-02 V3 컬럼 사전·상태·에러 코드·LOCAL password 위치 확정 (1일, P0)

### P1 — V3 데이터 기반

- [ ] P1-01 V3 DDL과 clean/V2 upgrade migration test 작성 (2일, P0)
...
- Clean MySQL 8.4: V1→Latest 성공률 100%.
